        ...
        if position == 1:
                    ...
                    if not patient.log_in():
                        ...
                        while True:
                            ...
                            if option1 == 3:
                                ...
                                while True:
                                    result_patinet_reserved = patient.select_patient_reserved_appointments_info(
                                        patient_national_code=input('Please enter your national code.'))
                                    table = PrettyTable()
                                    table.field_names = ["Patient National Code", "Patient Name", "Clinic ID",
                                ...
                                while True:
                                    ...
                                    table = PrettyTable()
                                    table.field_names = ["Clinic ID", "Service", "Capacity", "Reserved Appointments",
                                    ...
                                    if option2 == 1:
                                        ...
                                        number_of_appointments = int(
                                            input('Enter the number of appointments to reserve: '))
                                        patient_national_code = input('Enter the patient\'s national code: ')
                                        result_reservation = appointment.reserve_appointment(clinic_id,
                                        ...
                                        clinic_id = int(input('Please choose a clinic id: '))
                                        number_of_appointments = int(
                                            input('Enter the number of appointments to cancel: '))
                                        patient_national_code = input('Enter the patient\'s national code: ')
                                        result_cancellation = appointment.cancel_appointment(clinic_id,
                                                                                             number_of_appointments,
                                                                                             patient_national_code)
            ...
            while True:
                ...
                if option1 == 2:
                    ...
                    table = PrettyTable()
                    table.field_names = ["Patient National Code", "Patient Name", "Reserved Appointments",
                                         "Patient Age", "Patient Insurance", "Patient Contact Info"]
            ...
            while True:
                ...
                if option == 1:
                    ...
                    table = PrettyTable()
                    table.field_names = ["Patient National Code", "Patient Name", "Patient Age", "Patient Insurance",
                                         "Patient Contact Info", "Reserved Appointments"]
                    ...
                    if not doctor.view_patient_data():
                        break
                    result_view_patient = doctor.select_each_patient_info(
                        patient_national_code=input('Please enter your national code.'))
                    table = PrettyTable()
                    table.field_names = ["Patient National Code", "Patient Name", "Patient Age", "Patient Insurance",
                                         "Patient Contact Info", "Reserved Appointments"]
